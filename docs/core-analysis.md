...
This equals the sender-declared PLK1 plaintext digest in all eight transfers. A separate memory census found 352 retained memory records from eight Core processes whose 753,664-byte `.text` regions match SHA-256:
