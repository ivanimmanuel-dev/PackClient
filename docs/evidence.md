...
| Package specifically generated by Donut | Direct byte comparison to pinned official Donut v1.1 loader family | 11,674-byte terminal loader; attribution is build-specific |
...
| Carrier placement/start primitive | Direct static dataflow | Section-backed local-to-remote mapping plus primary-thread-context redirection; do not over-specify as classic image replacement |
...
| A/B resident and active in PID 5812 | Direct/strongly supported: exact maps, A-entry thread, immutable sections, VMMap and B-specific state | Carrier code now establishes section-backed placement and primary-thread redirection |
