...
| Local and September runs reached `154[.]36[.]188[.]201:443` but did not reproduce the July application session. | The client remained capable of initiating the network path. | Server inactivity, filtering, configuration drift and client-profile differences cannot be distinguished from the available evidence. |
